...
//subtitulo.setAttribute('class','alert alert-primary')
//subtitulo.setAttribute('class','text-primary')
...
function cambiar(estilo){
    let subtitulo = document.querySelector("#sub1");
    subtitulo.classList = estilo
    //lista.children[1].innerHTML = "<b>Cambio</b>"
    let elemento = document.createElement("li");
    elemento.innerText = estilo
...
console.log(inicio.parentElement)

//setAttribute('class','alert alert-primary')